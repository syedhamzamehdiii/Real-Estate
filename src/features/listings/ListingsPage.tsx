...
import { BUDGETS, LOCATIONS, PROPERTY_TYPES } from '../../data/site'
      ...
      <section className="section listings-hero">
        <Reveal>
          <SectionHead
            ...
            description="Filter by location, type, and budget. Every listing is personally checked by our team before it appears here."
          />
        </Reveal>
        <Reveal>
          <SearchPanel
